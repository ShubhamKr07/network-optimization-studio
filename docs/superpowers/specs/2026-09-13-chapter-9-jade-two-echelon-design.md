...
- `plant_wh_distance.json` — canonical `"plantId,warehouseId"` distance map (100)
- `wh_cust_distance.json` — canonical `"warehouseId,customerId"` distance map (2500)
