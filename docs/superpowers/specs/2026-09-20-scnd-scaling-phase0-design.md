...
> **SUPERSEDED as a spec — but §34 is STILL CONTROLLING. Do not read the rest as current.** This 243 KB file is an audit/split ledger; it was carved into **[`2026-09-21-scnd-solver-result-contract-design.md`](2026-09-21-scnd-solver-result-contract-design.md)** (correctness) and **[`2026-09-22-scnd-scaling-design.md`](2026-09-22-scnd-scaling-design.md)** (scaling), with execution in **[`../plans/2026-09-22-scnd-correctness-A-full-contract.md`](../plans/2026-09-22-scnd-correctness-A-full-contract.md)**. The one live section is **§34** (consolidated post-spike approval review, decisions **Q73–Q84**), which still gates the A plan — jump straight there and ignore everything else.
